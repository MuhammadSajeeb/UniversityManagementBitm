<%@ Page Title="View Courses" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewCourses.aspx.cs" Inherits="UniversityManagement.ViewCourses" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <br/>
    <h4> View Courses</h4>
       <div class="form-group">
            <div class="col-md-10">
                  <a class="nav-link" href="CourseSetup.aspx">Create New</a>
            </div>
       </div>
        ...
        <hr />
         <div class="form-group">
            <div class="col-md-offset-1 col-md-10">
              <asp:GridView ID="CoursesGridView" runat="server" Width="100%" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="10" ForeColor="Black" GridLines="Horizontal" AllowPaging="True" PageSize="2" CellSpacing="10" OnPageIndexChanging="CoursesGridView_PageIndexChanging">
                <Columns>
                   <asp:TemplateField HeaderText = "Serial No" ItemStyle-Width="130">
                    ...
                    <asp:BoundField DataField="CourseAssigneTo" HeaderText="Assigned To" />
